                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               @if($product['color'])
                                                ...
                                                @endif
                                                <p>
                                                        <strong>{{ __('Price') }} :</strong> {{PriceHelper::showOrderCurrencyPrice(round($product['item_price'] * $order->currency_value , 2),$order->currency_sign)}}
                                                </p>
                                               <p>
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice(round($product['price'] * $order->currency_value , 2),$order->currency_sign)}}</td>
                                        ...
                                        <tr class="semi-border">
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice(round($subtotal, 2),$order->currency_sign)}}</td>
                                        ...
                                        @endphp
                                            ...
                                            <tr class="no-border">
                                                ...
                                                <td>{{PriceHelper::showOrderCurrencyPrice(round($order->shipping_cost , 2),$order->currency_sign)}}</td>
                                            </tr>
                                            @endif
                                        @endif
                                        ...
                                        <tr class="no-border">
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice(round($order->packing_cost , 2),$order->currency_sign)}}</td>
                                        </tr>
                                        @endif
                                        @endif
                                        ...
                                        <tr class="no-border">
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice(round($tax, 2),$order->currency_sign)}}</td>
                                        </tr>
                                        ...
                                        <tr class="no-border">
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice(round($order->coupon_discount, 2),$order->currency_sign)}}</td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr class="no-border">
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice( round($order->wallet_price * $order->currency_value , 2),$order->currency_sign)}}
                                            </td>
                                        </tr>
                                            ...
                                            <tr class="no-border">
                                                ...
                                                <td>{{PriceHelper::showOrderCurrencyPrice( round($order->pay_amount * $order->currency_value , 2),$order->currency_sign)}}
                                                </td>
                                            </tr>
                                            @endif
                                        ...
                                        <tr class="final-border">
                                            ...
                                            <td>{{PriceHelper::showOrderCurrencyPrice( round(($order->pay_amount + $order->wallet_price) * $order->currency_value  , 2),$order->currency_sign)}}
                                            </td>
                                        </tr>
