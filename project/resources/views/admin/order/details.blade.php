                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{PriceHelper::showOrderCurrencyPrice(round($order->shipping_cost, 2),$order->currency_sign)}} </td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{PriceHelper::showOrderCurrencyPrice(round($order->packing_cost, 2),$order->currency_sign)}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{PriceHelper::showOrderCurrencyPrice( round(($order->pay_amount + $order->wallet_price)  * $order->currency_value , 2),$order->currency_sign)}}</td>
                                                    </tr>
                                                    @endif
