                                                        ...
                                                        <div class="billing-add-area">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <h5>{{ $langg->lang292 }}</h5>
                                                                    <p>
                                                                        {{ PriceHelper::showOrderCurrencyPrice( round(($order->pay_amount + $order->wallet_price) * $order->currency_value , 2),$order->currency_sign) }}
                                                                        </p>
...
@else
                                                            <div class="invoice__metaInfo">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <h5>{{ $langg->lang292 }}</h5>
                                                                    <p>{{ $langg->lang293 }}  {{ PriceHelper::showOrderCurrencyPrice( round(($order->pay_amount + $order->wallet_price) * $order->currency_value , 2),$order->currency_sign) }}</p>
                                                                    <p>{{ $langg->lang294 }} {{$order->method}}</p>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                  ...
                                                  <td>
                                                {{ PriceHelper::showOrderCurrencyPrice( round($product['item_price']* $order->currency_value,2),$order->currency_sign) }}
                                            </td>
                                            <td>
                                                {{ PriceHelper::showOrderCurrencyPrice( round($product['price'] * $order->currency_value,2),$order->currency_sign) }}
